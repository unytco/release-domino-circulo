...
| Releases                 |
|--------------------------|
| [macOS x64 (Intel)](https://github.com/unytco/release-domino-circulo/releases)            |
| [macOS arm64 (Silicon)](https://github.com/unytco/release-domino-circulo/releases)      |
| [Linux Debian](https://github.com/unytco/release-domino-circulo/releases) (recommended)    |
| [Linux AppImage](https://github.com/unytco/release-domino-circulo/releases) (read note below) |
...
https://github.com/unytco/release-domino-circulo/releases)
...
```
rm -rf co.unyt.domino.circulo
```

That co.unyt.domino.circulo file had your local data in it.
